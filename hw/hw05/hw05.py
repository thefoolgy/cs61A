def make_bank(balance):
    ...
    def bank(message, amount):
        ...
        if message == 'withdraw' and balance >= amount:
            ...
            balance += amount
            return balance
        elif  message == 'withdraw' and balance < amount:
            return 'Insufficient funds'
        elif message != 'withdraw' or message != 'deposit':
...
def make_withdraw(balance, password):
    ...
    def  withdraw(amount, input_password):
        nonlocal balance, password, password_lst
        if len(password_lst) >= 3:
            return "Too many incorrect attempts. Attempts: " + str(password_lst)
        if input_password == password and balance >= amount and len(password_lst)<3:
            balance -= amount
            return balance
        elif input_password == password and balance < amount and len(password_lst) < 3:
            return 'Insufficient funds'
        elif input_password != password:
            password_lst.append(input_password)
